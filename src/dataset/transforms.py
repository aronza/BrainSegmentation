...
class RandomRotate:
    ...
    def __init__(self, random_state, angle_spectrum=20, axes=None, mode='reflect', order=0, **kwargs):
        if axes is None:
            axes = [(1, 0), (2, 1), (2, 0)]
        else:
...
class RandomContrast:
    ...
    def __init__(self, random_state, alpha=(0.8, 1.2), mean=0.0, execution_probability=0.1, **kwargs):
        self.random_state = random_state
        assert len(alpha) == 2
        self.alpha = alpha
        self.mean = mean
