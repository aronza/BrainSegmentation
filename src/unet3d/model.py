...
class UNet3D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid=False, f_maps=64,
    ...
    def forward(self, x):
        ...
        # outputs logits and it's up to the user to normalize it before visualising with tensorboard or computing
        # validation metric
